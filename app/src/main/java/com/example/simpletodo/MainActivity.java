...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == EDIT_TEXT_CODE){
            ...
            // Extract the original posiiton of the edited item from the position key
    ...
    // load items by rendering every line of the data file
    private void loadItems() {
        try{
        items = new ArrayList<>(FileUtils.readLines(getDataFile(),null));
    } catch(IOException e){
